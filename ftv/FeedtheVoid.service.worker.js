...
/** @type {string} */
const CACHE_VERSION = '1771998355|7994703564';
/** @type {string} */
const CACHE_PREFIX = 'Feed the Void-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'FeedtheVoid.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["FeedtheVoid.html","FeedtheVoid.js","FeedtheVoid.offline.html","FeedtheVoid.icon.png","FeedtheVoid.apple-touch-icon.png","FeedtheVoid.audio.worklet.js","FeedtheVoid.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["FeedtheVoid.wasm","FeedtheVoid.pck"];
